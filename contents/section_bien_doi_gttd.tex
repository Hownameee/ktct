\section{Khái quát chung: Nền kinh tế tri thức và tính nguyên vẹn của Học thuyết giá trị thặng dư}

\subsection{Bối cảnh chuyển đổi: Sự chuyển dịch từ nền kinh tế công nghiệp sang kinh tế tri thức và CMCN 4.0}
...
\subsection{Bản chất cốt lõi không đổi: Sản xuất giá trị thặng dư là quy luật kinh tế tuyệt đối}
...
\subsection{Khẳng định nguyên lý: Máy móc không tự tạo ra GTTD, chỉ có lao động sống mới tạo ra}
...
\section{Sự biến đổi về nguồn gốc và động lực tạo ra giá trị thặng dư}

\subsection{Sự dịch chuyển hình thái lao động: Chuyển từ lao động cơ bắp sang bóc lột hàm lượng tri thức, chất xám}
...
\subsection{Khoa học công nghệ trở thành lực lượng sản xuất trực tiếp: Nguồn gốc chủ yếu tạo ra của cải}
...
\subsection{Động lực siêu lợi nhuận: Theo đuổi giá trị thặng dư siêu ngạch và tương đối}

Xét về chất, phương pháp sản xuất giá trị thặng dư siêu ngạch là động lực để phát triển kinh tế theo hướng kinh tế tri thức. Để theo đuổi giá trị thặng dư siêu ngạch, nhà tư bản đầu tư vào nghiên cứu khoa học công nghệ và ứng dụng khoa học công nghệ vào quá trình sản xuất \cite{tapchi_congthuong_gttd}.

Với mức giá trị thặng dư lớn và liên tục từ phương pháp sản xuất giá trị thặng dư siêu ngạch, các nhà tư bản không ngừng cải tiến kỹ thuật, hợp lý hóa sản xuất, tăng năng suất lao động nhằm hạ giá trị hàng hóa. Với khát vọng tăng lượng giá trị thặng dư, các nhà tư bản không ngừng đầu tư nghiên cứu và ứng dụng khoa học kỹ thuật, đồng thời họ chuyển hướng đối tượng kinh tế của mình sang đầu tư tư bản vô hình là tri thức, là chất xám có sẵn trong người lao động \cite{tapchi_congthuong_gttd}.

Bởi giá trị thu được từ nguồn nguyên liệu có sẵn trong tự nhiên là hữu hạn, nhưng lượng giá trị có được từ hàm lượng tri thức của người lao động là vô hạn, càng khai thác càng phát huy giá trị. Ở Mỹ, kết quả tính toán cho thấy: 1\% gia tăng chi phí lao động đưa lại sản lượng gấp ba lần so với việc tăng 1\% vốn \cite{tapchi_congthuong_gttd}.

Do khoa học, công nghệ và đổi mới sáng tạo được áp dụng ngày càng phổ biến, nên khối lượng giá trị thặng dư được tạo ra chủ yếu nhờ tăng năng suất lao động. Việc tăng năng suất lao động do áp dụng kỹ thuật và công nghệ hiện đại có đặc điểm là chi phí lao động sống cho một đơn vị sản phẩm giảm nhanh, vì máy móc hiện đại thay thế được nhiều lao động sống hơn. Hơn nữa, nhà tư bản thông qua sử dụng ồ ạt các thiết bị tự động hóa, đem khoa học -- kỹ thuật hiện đại ứng dụng với quy mô lớn vào sản xuất, đã nâng cao rất nhiều lần năng suất lao động \cite{tran_hieu_gttd}.

Trong điều kiện Cách mạng công nghiệp 4.0, giá trị thặng dư chủ yếu được tạo ra thông qua việc nâng cao năng suất lao động, rút ngắn thời gian lao động tất yếu và kéo dài tương đối thời gian lao động thặng dư \cite{tran_hieu_gttd}. Tư liệu lao động tiên tiến, hiện đại làm tăng năng suất lao động dẫn tới rút ngắn thời gian lao động cần thiết, tăng thời gian lao động thặng dư, nên tăng giá trị thặng dư tương đối \cite{do_the_tung_gttd}.

\section{Sự biến đổi về phương thức và hình thức bóc lột (Ngày càng tinh vi hơn)}

\subsection{Sự che giấu qua các ``van điều áp'' xã hội}
...
\subsection{Bóc lột trong không gian số và kinh tế nền tảng (Gig Economy)}
...
\subsection{Công nghệ san bằng lợi thế tự nhiên}
...
\section{Sự biến đổi về vị trí của người lao động và thước đo sự giàu có}

\subsection{Vai trò mới của người lao động}
...
\section{Sự mở rộng quy mô bóc lột (Tình trạng toàn cầu hóa giá trị thặng dư)}

\subsection{Bóc lột mang tính quốc tế}

Điểm cần lưu ý, xem xét quan hệ bóc lột của chủ nghĩa tư bản ngày nay không chỉ bó hẹp trong quan hệ giữa nhà tư bản và người lao động làm thuê ở các nước tư bản chủ nghĩa, mà phải xem xét cả quan hệ thống trị, bóc lột của các nước phát triển với các nước kém và đang phát triển \cite{tran_hieu_gttd}.

Sự bóc lột giá trị thặng dư của chủ nghĩa tư bản đã mang ``tính quốc tế''. Ngày nay, trong điều kiện toàn cầu hóa, Chủ nghĩa tư bản độc quyền nhà nước quốc tế, thông qua các hình thức, như xuất khẩu tư bản, di chuyển lao động từ nước này sang nước khác, việc bành trướng của các công ty xuyên quốc gia, tình trạng bất bình đẳng trong các quan hệ thương mại quốc tế, sự xuất hiện cái gọi là chủ nghĩa thực dân kinh tế,... khiến cho việc sản xuất giá trị thặng dư mang tính quốc tế, được tư bản hóa, được xuất khẩu để quốc tế hóa tư bản với sự đa dạng của các hình thức sản xuất ra nó \cite{tran_hieu_gttd}.

\subsection{Chuyển dịch bất bình đẳng}

Những sự ``điều chỉnh'' để thích ứng của chủ nghĩa tư bản tuy có tác động tới sự phát triển, song đưa lại hệ quả xấu là khoét sâu thêm khoảng cách giữa giàu và nghèo, làm cho các nước nghèo ngày càng nghèo hơn, các nước giàu ngày càng giàu hơn \cite{tran_hieu_gttd}.

Tích tụ tư bản và bóc lột công nhân là hai quá trình thực tế không tách rời nhau. Điều đó được xác nhận qua sự thành lập các tập đoàn kinh tế khổng lồ trên cơ sở tăng cường bóc lột bằng những phương thức mới, qua nạn thất nghiệp phổ biến đang trở thành hiện tượng kinh niên. Đi kèm sự phát triển của chủ nghĩa tư bản là hiện tượng tăng tư bản bất biến (dùng để mua tư liệu sản xuất) và giảm tư bản khả biến (dùng để mua lao động). Thể hiện ở sự phân hóa hai cực: giàu, nghèo của thế giới \cite{tran_hieu_gttd}.
