...
\begin{itemize}
    ...
    \item \textbf{Tầng bậc 3: Nền tảng cho toàn bộ hệ thống lý luận Mác-Lênin}. Học thuyết này là cơ sở để phân tích sự tích lũy tư bản, khủng hoảng kinh tế và sự phân chia giai cấp. Nó cho thấy sự vận động của tư bản là một chu trình liên tục:
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{images/mo_hinh_tu_ban.png}
        \caption{Mô hình của tuần hoàn tư bản}
    \end{figure}
    Để thực hiện được giá trị thặng dư, hàng hóa phải được bán đi trên thị trường; nếu không, chu trình sẽ đứt gãy và dẫn đến khủng hoảng.
\end{itemize}
